      ...
      >
        <Box sx={style}>
          <div className="flex">
            ...
            <div className="w-[50%]">
              <img src={`https://img.vietqr.io/image/${pmData?.fundingProject.wallet.bankAccount.bankCode}-${pmData?.fundingProject.wallet.bankAccount.bankNumber}-compact2.jpg?amount=${pmData?.fundingProject.balance * pmData?.milestone.disbursementPercentage * 0.5 * 0.95}&addInfo=milestone%20request`} />
            </div>
          </div>
        </Box>
